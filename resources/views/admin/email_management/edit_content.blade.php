    ...
    <div class="page-inner">
        ...
        <div class="row">
            ...
            @csrf
                ...
                <div class="form-group">
                    <label>Subject</label>
                    <input type="text" name="subject" id="subject" value="{{$users->subject}}" class="form-control" >
                    <span class="text-danger  ">
                                        @error('subject')
                                        {{$message}}
                                        @enderror
                ...
                <div class="form-group">
                    <label>Message</label>
                    <input type="text" name="message" id="message" value="{{$users->message}}" class="form-control" >
                    <span class="text-danger  ">
                                        @error('message')
                                        {{$message}}
                                        @enderror
