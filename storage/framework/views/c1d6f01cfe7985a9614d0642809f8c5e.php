                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input class="form-check-input" type="checkbox"
                                                            name="add[<?php echo e($users->id); ?>]"
                                                            value="<?php echo e($users->module_name); ?>" id="" />
                                                    </td>
                                                    <td>
                                                        <input class="form-check-input" type="checkbox"
                                                            name="edit[<?php echo e($users->id); ?>]"
                                                            value="<?php echo e($users->module_name); ?>" id="" />
                                                    </td>
                                                    <td>
                                                        <input class="form-check-input" type="checkbox"
                                                            name="delete[<?php echo e($users->id); ?>]"
                                                            value="<?php echo e($users->module_name); ?>" id="" />
                                                    </td>
                                                    <td>
                                                        <input class="form-check-input" type="checkbox"
                                                            name="view[<?php echo e($users->id); ?>]"
                                                            value="<?php echo e($users->module_name); ?>" id="" />
                                                    </td>
                                                </tr>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
