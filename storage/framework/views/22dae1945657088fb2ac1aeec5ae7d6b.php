            ...
            <div class="col-md-12">
                ...
                <div class="card-header">
                        ...
                        <div class="d-flex align-items-center">
                            <a href="<?php echo e(url('user/adduser')); ?>"><button class="btn btn-primary btn-round ml-auto" data-toggle="modal"
                                    ...
                                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $users): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <td><?php echo e($loop->iteration); ?></td>
                                            ...
                                            <td class="action_td">
                                                    ...
                                                    <a href="<?php echo e(url('user/edit_user/'.  $users->id)); ?>" data-toggle="tooltip" title=""
                                                    ...
                                                    ?>
                                                     ...
                                                     <a href="<?php echo e(url('user/UserChangeStatus/'. $users->id.'/'. $status)); ?>"
                                                    ...
                                                    <a href="/user/delete_user/<?php echo e($users->id); ?>"
...
<?php echo $__env->make('layouts.user-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp\www\dms\resources\views/user/user/userManagement.blade.php ENDPATH**/ ?>