    ...
    <div class="page-inner">
        <div class="page-header">
            <ul class="breadcrumbs">
                ...
                <li class="nav-item">
                    <a href="<?php echo e(url('company/document')); ?>">Document Management</a>
                </li>
                <li class="separator">
                    <i class="flaticon-right-arrow"></i>
                </li>
        ...
        <div class="row">
            <div class="col-md-10">
                <div class="card">
                    ...
                    <div class="card-body">
                <form action="<?php echo e(url('company/createdocument')); ?>" method="post" id="files"
                    ...
                    <div class="form-row">
                        ...
                        <?php $__currentLoopData = $project_documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project_documents): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($project_documents->id); ?>"> <?php echo $project_documents->project_name;?></option>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <?php $__currentLoopData = $category_documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category_documents): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($category_documents->id); ?>"><?php echo $category_documents->name;?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        <span class="text-danger error ">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php $__currentLoopData = $document_type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($document_type->id); ?>"><?php echo $document_type->name?></option>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        <span class="text-danger error ">
...
unset($__errorArgs, $__bag); ?>
                     ...
                     <div class="text-right">
                                ...
                                <a href="<?php echo e(url('company/document')); ?>" class="mt-4 btn btn-danger">Cancel</a>
                    <div>
                </form>
            </div>
        </div>
...
<?php echo $__env->make('layouts.company-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp\www\dms\resources\views/company/document/createdocument.blade.php ENDPATH**/ ?>