                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="d-flex align-items-center">
                            <a href="<?php echo e(url('company/project')); ?>"><button class="btn btn-primary btn-round ml-auto"
                            ...
                            <table id="datatables" class="display table table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="action_td">
                                            <a href="<?php echo e(url('/company/update_project/' .$project->id)); ?>"
                                            ...
                                            <a href="<?php echo e(url('/company/ProjectChangeStatus/'. $project->id.'/'. $status)); ?>"
                                            ...
                                            <a href="<?php echo e(url('company/delete_project/' .$project->id)); ?>"
...
<?php echo $__env->make('layouts.company-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\dms\resources\views/company/project_management/view_project.blade.php ENDPATH**/ ?>