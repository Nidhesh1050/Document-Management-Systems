                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="d-flex align-items-center">
                            <a href="<?php echo e(url('admin/content')); ?>"><button class="btn btn-primary btn-round ml-auto"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-button-action">
                                                    ...
                                                    <a href="/admin/delete/<?php echo e($user->id); ?>" onclick="return confirm('Are you sure you want to delete this email content ?')">
                                                        <button type="button" data-toggle="tooltip" title=""
