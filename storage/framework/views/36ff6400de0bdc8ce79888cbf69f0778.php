                            ...
                            <form action="<?php echo e(url('admin/edit_category')); ?>" id="category_edit" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <option <?php if($users->parent_id == $parent_categories->id){?>selected <?php } ?> value="<?php echo e($parent_categories->id); ?>"><?php echo e($parent_categories->name); ?></option>
                                        <?php }?>
                                    </select>
                                    </div>
                                    <div class="form-group  col-md-6">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="text-right">
                                    ...
                                    <a href="<?php echo e(url('admin/view_category')); ?>" class="mt-4 btn btn-danger">Cancel</a>
                                    <div>
