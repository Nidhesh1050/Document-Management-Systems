    ...
    <div class="page-inner">
        <div class="page-header">
            <ul class="breadcrumbs">
                ...
                <li class="nav-item">
                    <a href="<?php echo e(url('company/documentType_view')); ?>">Document Management</a>
                </li>
                <li class="separator">
                    <i class="flaticon-right-arrow"></i>
                </li>
        ...
        <div class="row">
            <div class="col-md-10">
                <div class="card">
                    ...
                    <div class="card-body">
                    <form action="<?php echo e(url('company/documentType_add')); ?>" method="post" id="validate">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.company-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp\www\dms\resources\views/company/document_type/documentType_add.blade.php ENDPATH**/ ?>