    ...
    <div class="page-inner">
        ...
        <div class="card-header">
            ...
            <div class="d-flex align-items-center">
                <a href="<?php echo e(url('company/documentType_add')); ?>"><button class="btn btn-primary btn-round ml-auto"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="action_td">
                                ...
                                <a href="<?php echo e(url('company/documentType_edit/'. $documentTypes->id)); ?>" data-toggle="tooltip"
                                ...
                                <a href="<?php echo e(url('/company/DocumentTypeChangeStatus/'. $documentTypes->id.'/'. $status)); ?>"
                                ...
                                <a href="<?php echo e(url('company/documentType_delete/'. $documentTypes->id)); ?>"
...
<?php echo $__env->make('layouts.company-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp\www\dms\resources\views/company/document_type/documentType_view.blade.php ENDPATH**/ ?>